...
export const SavingsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        calculateSavings: async (household: Household, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SavingsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async calculateSavings(household: Household, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Savings>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.calculateSavings(household, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SavingsApi.calculateSavings']?.[localVarOperationServerIndex]?.url;
...
export const SavingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        calculateSavings(household: Household, options?: RawAxiosRequestConfig): AxiosPromise<Savings> {
            return localVarFp.calculateSavings(household, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SavingsApi extends BaseAPI {
     ...
     * @memberof SavingsApi
     */
    public calculateSavings(household: Household, options?: RawAxiosRequestConfig) {
        return SavingsApiFp(this.configuration).calculateSavings(household, options).then((request) => request(this.axios, this.basePath));
    }
}
